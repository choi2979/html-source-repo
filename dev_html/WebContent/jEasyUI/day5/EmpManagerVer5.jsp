...
<%@ include file="./JEasyUICommon.jsp" %>
    ...
    function empList(){
			$('#dg_emp').datagrid({
				url:"http://192.168.0.119:8000/dev_html/jEasyUI/day5/jsonEmpList.jsp"
...
*/
	...
	<div id="dlg_ins" data-options="closed:true, title:'사원정보 등록'" class="easyui-dialog" style="width:100%;max-width:480px;padding:30px 60px">
		<form id="f_ins">
			...
			<div style="margin-bottom:10px">
				<input class="easyui-datebox" id="hiredate" name="hiredate" label="입사일자" labelPosition="top" data-options="prompt:'Enter a HIREDATE'" style="width:250px">
			</div>
			<div style="margin-bottom:10px">
			...
			<div style="margin-bottom:10px">
				<input class="easyui-combobox" id="deptno" name="deptno" label="부서번호" labelPosition="top" data-options="prompt:'Enter a DEPTNO'" style="width:250px">
			</div>
			<div style="margin-bottom:10px">
